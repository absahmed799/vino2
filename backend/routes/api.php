...
// Routes pour ListeAchatController
// Récupérer le panier de l'utilisateur
Route::get('/liste-achat', [ListeAchatController::class, 'index']);
Route::get('/liste-achat/utilisateur/{utilisateurId}', [ListeAchatController::class, 'show']);

// Mettre à jour le panier de l'utilisateur
Route::put('/liste-achat/utilisateur/{utilisateurId}', [ListeAchatController::class, 'update']);
