...
class ListeAchatController extends Controller
{
    ...
    {
        $listesAchat = ListeAchat::all(); // Exemple de récupération de toutes les listes d'achat à l'aide d'un modèle Eloquent

        return response()->json($listesAchat); // Retourner les listes d'achat sous forme de réponse JSON
    }
